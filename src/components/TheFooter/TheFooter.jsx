        ...
        <div className={styles.footerTop}>
          ...
          <div className={styles.footerItem}>
            <div className={styles.footerNav}>
              <Link className={styles.footerNavItem} href="/">Home</Link>
              <Link className={styles.footerNavItem} href="/">About</Link>
              <Link className={styles.footerNavItem} href="/">Development</Link>
              <Link className={styles.footerNavItem} href="/">Portfolio</Link>
              <Link className={styles.footerNavItem} href="/">Contact</Link>
            </div>
          </div>
          <div className={styles.footerItem}>
          ...
          <div className={styles.footerItem}>
            <p className={styles.footerText}>Let's be a friends</p>
            <div className={styles.footerSocial}>
              <Link className={styles.footerSocialItem} href="/">
